...
namespace KitapSatisSayfasi.Models.Configuration
{
    public class UyeCFG : IEntityTypeConfiguration<Uye>
    {
        ...
        {
            Uye uye = (new Uye() { Id = 1,Ad = "Zeynel",Soyad = "Şahin",UserName = "Zeynel", NormalizedUserName = "Zeynel", Email = "zeynelsahin@zeynelsahin.com", NormalizedEmail = "zeynelsahin@zeynelsahin.com", EmailConfirmed = false, Adres = "Ümraniye" });
